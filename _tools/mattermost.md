...
<table class="table table-bordered" style="font-size: 14px">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="table-success">Yes</td>
      <td>You can also press the Shift and Return keys to go to the next line.</td>
    </tr>
    <tr>
...
- [The Magic of Mattermost Markdown](https://www.mattermost.org/open-source-slack-alternative-adopts-markdown/)
