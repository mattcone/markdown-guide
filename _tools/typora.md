...
title: Typora
category: documents
description: "Typora is a simple and configurable Markdown editor designed for documents."
icon: typora.png
...
<table class="table table-bordered" style="font-size: 14px">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="table-success">Yes</td>
      <td>Automatically generated. For example, if you have a heading called <code>Heading IDs</code>, you can link to it with <code>[link](#heading-ids)</code>. There's apparently no ability to set custom heading IDs. It's unclear what happens when there are two identical headings.</td>
    </tr>
    <tr>
...
As an added bonus, Typora provides support for several obscure elements:
