...
You don't even need to download anything. There are several online Markdown editors that you can use to try writing in Markdown. [JotBird](https://www.jotbird.com) (which I built) is one of the best. Just open the site and start typing in the left pane. A preview of the rendered document appears in the right pane.

{% include image.html file="/assets/images/jotbird.png" alt="JotBird Markdown editor" lazy="yes" %}

JotBird does one more thing worth knowing about. When you've written something you want to share — notes, a doc, a README — you can publish it to a real web page with its own link in one click. So it's not just a place to practice Markdown — it's a place to do something with it.
