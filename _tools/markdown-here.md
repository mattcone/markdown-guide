...
<table class="table table-bordered" style="font-size: 14px">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="table-success">Yes</td>
      <td>You can also press the Return key once to achieve the same result.</td>
    </tr>
    <tr>
...
- [Markdown Here compatibility list](https://github.com/adam-p/markdown-here/wiki/Compatibility)
- [Markdown Here repository on GitHub](https://github.com/adam-p/markdown-here)
