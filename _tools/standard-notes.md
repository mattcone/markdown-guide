...
Standard Notes, through the [Advanced Markdown extension](https://standardnotes.org/extensions/advanced-markdown), provides support for the following Markdown elements.
...
<table class="table table-bordered" style="font-size: 14px">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="table-success">Yes</td>
      <td>You can use either one or two tilde symbols before and after the phrase.</td>
    </tr>
    <tr>
...
- [Standard Notes web application GitHub repository](https://github.com/standardnotes/web)
